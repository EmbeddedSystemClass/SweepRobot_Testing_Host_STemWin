...
void SweepRobotTest_StepMotorDriverGPIOInit(void)
{
    ...
    RCC_AHB1PeriphClockCmd(STEP_MOTOR_DRIVER_GPIO_PERIPH_ID|STEP_MOTOR_DRIVER_24V_CTRL_GPIO_PERIPH_ID|STEP_MOTOR_DRIVER_POS_DETECT_GPIO_PERIPH_ID, ENABLE);
    ...
    GPIO_InitStructure.GPIO_Pin = STEP_MOTOR_DRIVER_24V_CTRL_PIN;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
    GPIO_Init(STEP_MOTOR_DRIVER_24V_CTRL_GPIO, &GPIO_InitStructure);

    GPIO_InitStructure.GPIO_Pin = STEP_MOTOR_DRIVER_POS_DETECT_PIN;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;
    GPIO_Init(STEP_MOTOR_DRIVER_POS_DETECT_GPIO, &GPIO_InitStructure);
