...
#define __EJE_SWRB_TEST_SERIALREC_DLG       1
#define __EJE_SWRB_TEST_CONTROL_DLG         1
...
#if defined __EJE_SWRB_TEST_SERIALREC_DLG && defined USE_SERIALREC
    #include "EJE_SWRB_TEST_SerialRecDLG.h"
#endif

#if __EJE_SWRB_TEST_CONTROL_DLG
    #include "EJE_SWRB_TEST_ControlDLG.h"
#endif
/*********************************************************************
*
*       Defines
...
/* EJE_SWRB_TEST_StartDLG */
    ...
    enum ID_START_BUTTON{
        ...
        ID_START_BUTTON_CONTROL,
        ID_START_BUTTON_MANUL_MANUL_MODE,
        ID_START_BUTTON_SERIAL_REC,
...
/* EJE_SWRB_TEST_MainDLG */
    ...
    enum ID_PCBTEST_BUTTON{
        ...
        ID_PCBTEST_BUTTON_INDICATE_KEY,
        ID_PCBTEST_BUTTON_SKIP_KEY,
    ...
    enum ID_PCBTEST_TEXT{
        ID_PCBTEST_TEXT_INDICATE_KEY = ID_PCBTEST_TEXT_0,
...
#if __EJE_SWRB_TEST_SERIALREC_DLG
    enum ID_SERIALREAD_WIDGET{
        ID_SERIALREAD_WINDOW_0 = ID_RELAYCTRL_BOUND,
        ID_SERIALREAD_MULTIEDIT_0,
        ID_SERIALREAD_BUTTON_0,
        ID_SERIALREAD_BUTTON_1,
        ID_SERIALREAD_BUTTON_2,
        ID_SERIALREAD_BUTTON_3,
        ID_SERIALREAD_BOUND,
    };

    enum ID_SERIALREAD_WINDOW{
        ID_SERIALREAD_WINDOW_MAIN = ID_SERIALREAD_WINDOW_0,
        ID_SERIALREAD_WINDOW_BOUND,
    };

    enum ID_SERIALREAD_MULTIEDIT{
        ID_SERIALREAD_MULTIEDIT_MAIN = ID_SERIALREAD_MULTIEDIT_0,
        ID_SERIALREAD_MULTIEDIT_BOUND,
    };

    enum ID_SERIALREAD_BUTTON{
        ID_SERIALREAD_BUTTON_TEST_ON = ID_SERIALREAD_BUTTON_0,
        ID_SERIALREAD_BUTTON_MANUL_READ_ON,
        ID_SERIALREAD_BUTTON_RESET,
        ID_SERIALREAD_BUTTON_EXIT,
        ID_SERIALREAD_BUTTON_BOUND,
    };
#endif

#if __EJE_SWRB_TEST_CONTROL_DLG
    enum ID_CONTROL_WIDGET{
        ID_CONTROL_WINDOW_0 = ID_SERIALREAD_BOUND,
        ID_CONTROL_BUTTON_0,
        ID_CONTROL_BUTTON_1,
        ID_CONTROL_BUTTON_2,
        ID_CONTROL_BUTTON_3,
        ...
        ID_CONTROL_BUTTON_8,
        ID_CONTROL_BUTTON_9,
        ID_CONTROL_BUTTON_10,
        ID_CONTROL_BUTTON_11,
        ID_CONTROL_BUTTON_12,
        ID_CONTROL_BUTTON_13,
        ID_CONTROL_BOUND,
    };

    enum ID_CONTROL_WINDOW{
        ID_CONTROL_WINDOW_MAIN = ID_CONTROL_WINDOW_0,
        ID_CONTROL_WINDOW_BOUND,
    };

    enum ID_CONTROL_BUTTON{
        ID_CONTROL_BUTTON_START = ID_CONTROL_BUTTON_0,
        ID_CONTROL_BUTTON_STOP,
        ID_CONTROL_BUTTON_SET,
        ID_CONTROL_BUTTON_EXIT,
        ID_CONTROL_BUTTON_PLAN,
        ID_CONTROL_BUTTON_CHARGE,
        ID_CONTROL_BUTTON_UP,
        ID_CONTROL_BUTTON_LEFT,
        ID_CONTROL_BUTTON_RIGHT,
        ID_CONTROL_BUTTON_DOWN,
        ID_CONTROL_BUTTON_ONOFF,
        ID_CONTROL_BUTTON_MODE,
        ID_CONTROL_BUTTON_MODE2,
        ID_CONTROL_BUTTON_SPOT,
        ID_CONTROL_BUTTON_BOUND,
    };
...
#if __EJE_SWRB_TEST_SERIALREC_DLG
    extern WM_HWIN hWin_SWRB_SERIALREC;
#endif

#if (defined __EJE_SWRB_TEST_CONTROL_DLG && defined USE_RMT_CTRL)
    extern WM_HWIN hWin_SWRB_CONTROL;
#endif
