...
static const GUI_WIDGET_CREATE_INFO _aPCBTestMainDialogCreate[] = {
    ...
    { CHECKBOX_CreateIndirect,  "cbxIRDA",        ID_PCBTEST_CHECKBOX_IRDA,  460, 297, 210, 25, 0, 0x0, 0 },
    { CHECKBOX_CreateIndirect,  "cbxCharge",      ID_PCBTEST_CHECKBOX_CHARGE, 460, 332, 210, 25, 0, 0x0, 0 },
    ...
    { CHECKBOX_CreateIndirect,  "cbxKey",         ID_PCBTEST_CHECKBOX_KEY, 460, 437, 210, 25, 0, 0x0, 0 },
