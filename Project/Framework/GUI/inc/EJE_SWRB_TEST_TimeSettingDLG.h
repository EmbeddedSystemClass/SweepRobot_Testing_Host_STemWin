...
**********************************************************************
*/
#define ID_TIMESET_LISTWHEEL_0 (ID_SNSET_BOUND + 0x00)
#define ID_TIMESET_LISTWHEEL_1 (ID_SNSET_BOUND + 0x01)
#define ID_TIMESET_LISTWHEEL_2 (ID_SNSET_BOUND + 0x02)
#define ID_TIMESET_LISTWHEEL_3 (ID_SNSET_BOUND + 0x03)
#define ID_TIMESET_LISTWHEEL_4 (ID_SNSET_BOUND + 0x04)
#define ID_TIMESET_LISTWHEEL_5 (ID_SNSET_BOUND + 0x05)
#define ID_TIMESET_EDIT_0 (ID_SNSET_BOUND + 0x10)
#define ID_TIMESET_EDIT_1 (ID_SNSET_BOUND + 0x11)
#define ID_TIMESET_EDIT_2 (ID_SNSET_BOUND + 0x12)
#define ID_TIMESET_EDIT_3 (ID_SNSET_BOUND + 0x13)
#define ID_TIMESET_EDIT_4 (ID_SNSET_BOUND + 0x14)
#define ID_TIMESET_EDIT_5 (ID_SNSET_BOUND + 0x15)
#define ID_TIMESET_EDIT_6 (ID_SNSET_BOUND + 0x16)
#define ID_TIMESET_EDIT_7 (ID_SNSET_BOUND + 0x17)
#define ID_TIMESET_FRAMEWIN_0 (ID_SNSET_BOUND + 0x20)
#define ID_TIMESET_WINDOW_0 (ID_SNSET_BOUND + 0x21)
#define ID_TIMESET_BUTTON_0 (ID_SNSET_BOUND + 0x30)
#define ID_TIMESET_BUTTON_1 (ID_SNSET_BOUND + 0x31)
#define ID_TIMESET_BUTTON_2 (ID_SNSET_BOUND + 0x32)
#define ID_TIMESET_BUTTON_3 (ID_SNSET_BOUND + 0x33)
#define ID_TIMESET_BUTTON_4 (ID_SNSET_BOUND + 0x34)
#define ID_TIMESET_BUTTON_5 (ID_SNSET_BOUND + 0x35)
#define ID_TIMESET_BUTTON_6 (ID_SNSET_BOUND + 0x36)
#define ID_TIMESET_BUTTON_7 (ID_SNSET_BOUND + 0x37)
#define ID_TIMESET_BUTTON_8 (ID_SNSET_BOUND + 0x38)
#define ID_TIMESET_TEXT_0 (ID_SNSET_BOUND + 0x40)
#define ID_TIMESET_BOUND (ID_SNSET_BOUND + 0x50)
