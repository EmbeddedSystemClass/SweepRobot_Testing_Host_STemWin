...
#define ID_PS_TEXT_1    (ID_TIMESET_BOUND + 0x26)
#define ID_PS_TEXT_2    (ID_TIMESET_BOUND + 0x27)
#define ID_PS_EDIT_0    (ID_TIMESET_BOUND + 0x30)
#define ID_PS_EDIT_1    (ID_TIMESET_BOUND + 0x31)
...
#define ID_PS_TEXT_VOLTAGE  ID_PS_TEXT_1
#define ID_PS_TEXT_CURRENT  ID_PS_TEXT_2
#define ID_PS_EDIT_VOLTAGE  ID_PS_EDIT_0
#define ID_PS_EDIT_CURRENT  ID_PS_EDIT_1
