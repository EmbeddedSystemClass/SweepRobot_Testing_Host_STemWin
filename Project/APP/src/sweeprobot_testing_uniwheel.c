    ...
    while(1){
        ...
        if(!Checkbox_Get_State(ID_CHECKBOX_UNIWHEEL)){
            ...
            if(uniwheel.validFlag){
                ...
                Progbar_Set_Value( (u8)((float)( (float)(SWRB_UNIWHEEL_TEST_TASK_PRIO-SWRB_TEST_TASK_PRIO_BOUND_MINUS_NUM) / (float)(SWRB_UNIWHEEL_TEST_TASK_PRIO-SWRB_TEST_TASK_PRIO_BOUND_MINUS_NUM))*100) );
